...
public class LocaleManagerTest {
  ...
  public void testLocaleManager() {
    ...
    List<Locale> supportedLocales_1 = LocaleHelpersTest.constructListOfLocales(SUPPORTED_LOCALES_1);
    ...
    List<Locale> supportedLocales_2 = LocaleHelpersTest.constructListOfLocales(SUPPORTED_LOCALES_2);
    ...
    List<Locale> expectedLocales_2 = LocaleHelpersTest.constructListOfLocales(expectedLocs_2);
    assertEquals(expectedLocales_2, LocaleManager.getSupportedLocales());

    // register 3rd application
    List<Locale> supportedLocales_3 = LocaleHelpersTest.constructListOfLocales(SUPPORTED_LOCALES_3);
    ...
    List<Locale> expectedLocales_3 = LocaleHelpersTest.constructListOfLocales(expectedLocs_3);
    assertEquals(expectedLocales_3, LocaleManager.getSupportedLocales());

    // register 4th application
    List<Locale> supportedLocales_4 = LocaleHelpersTest.constructListOfLocales(SUPPORTED_LOCALES_4);
    ...
    List<Locale> expectedLocales_4 = LocaleHelpersTest.constructListOfLocales(expectedLocs_4);
    assertEquals(expectedLocales_4, LocaleManager.getSupportedLocales());

    // register 5th application
    List<Locale> supportedLocales_5 = LocaleHelpersTest.constructListOfLocales(SUPPORTED_LOCALES_5);
    ...
    List<Locale> expectedLocales_5 = LocaleHelpersTest.constructListOfLocales(expectedLocs_5);
